...
if __name__ == '__main__':
    ...
    x,x_dot,x_dot_dot,y,y_dot,y_dot_dot,z,z_dot,z_dot_dot,yaw=ms.get_trajectory_var()
    gen=np.array((x,x_dot,x_dot_dot,y,y_dot,y_dot_dot,z,z_dot,z_dot_dot,yaw))
    with open('pickled_traj2.txt','wb') as gt:
        pickle.dump(gen, gt)
